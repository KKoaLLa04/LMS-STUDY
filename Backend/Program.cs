...
builder.Services.AddScoped<IAchievementGroupService, AchievementGroupService>();
builder.Services.AddScoped<IAchievementConditionService, AchievementConditionService>();
